...
func Test_argsFromCommandLine(t *testing.T) {
	...
	tests := []struct {
		...
		{"datadog-api-key-secret-id", setup("--datadog-api-key-secret-id", "projects/***REMOVED***/secrets/datadog-api-key/versions/latest"), args{"bqmetricstest"}, arguments{datadogAPIKeySecretID: "projects/***REMOVED***/secrets/datadog-api-key/versions/latest"}},
...
func Test_argsFromEnv(t *testing.T) {
	...
	tests := []struct {
		...
		{"datadog_api_key_secret_id", setup("DATADOG_API_KEY_SECRET_ID", "projects/***REMOVED***/secrets/datadog-api-key/versions/latest"), arguments{datadogAPIKeySecretID: "projects/***REMOVED***/secrets/datadog-api-key/versions/latest"}},
